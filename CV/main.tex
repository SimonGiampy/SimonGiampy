...
\bg{cvorange}{white}{Robots \& Sensors} \\[0.5em]
...
\bg{cvorange}{white}{Embedded Systems}\\[0.5em]
...
{Leonardo Innovation Labs}{Genoa, Italy \color{cvorange}~\faMapMarker}
...
\setlist{leftmargin=1em, itemsep=0pt} % left margin in list, reduce items separation
\begin{itemize}[label=$\circ$]
\item \textbf{GCAP Project}: autonomous robotic maintenance of future jet aircraft.
...
\item \textbf{MATISSE Project}: European project collaboration for the digital twin simulation of On-Orbit-Servicing robotic tasks.
...
\cvwork{2025}{Igus ROIBOT Award for Low-Cost Automation}{Igus Low-Cost Autonomy}{\href{https://www.deib.polimi.it/ita/notizie/dettagli/1401}{\underline{Award and Project Description}}}
{\includegraphics[width=1.5cm]{Igus_logo.png}}
{p{0.62\textwidth}}
{My thesis project won the first place of this Award in the university category, a competition in which universities and companies participated from all over the world. My project was awarded for its high impact, creativity and novelty for agricultural applications focused on reducing environmental impact.}
...
{\href{https://learn.nvidia.com/certificates?id=M6jS7p7FRhmhXXMu4Z_t6g}{\underline{Certificate}}}
{Programming and exercises on CUDA C/C++ and acceleration of custom CUDA kernel with concurrent data streams and performance profiling}
...
{\href{https://learn.nvidia.com/certificates?id=CR-g0KpOR02Jye_ZNDyQTg}{\underline{Certificate}}}
...
{Nvidia Deep Learning Institute}{\href{https://learn.nvidia.com/certificates?id=DHSO_ayiRNq-8NLGQCp45Q}{\underline{Certificate}}}
{Exercises on Data Science and Analytics using GPU-accelerated libraries: cuDF (Pandas), cuML (Scikit-Learn) and cuPy (Numpy)}
{\includegraphics[width=2cm]{nvidia-logo.png}}
...
\begin{tabular}{r !{\bulletseparator} p{0.62\textwidth} }
    ...
    \cvproj{2021}{Vivado project: image histogram equalization in VHDL}{Vivado Xilinx $\cdot$ VHDL $\cdot$ FPGA}{https://github.com/SimonGiampy/Progetto_Reti_Logiche_Polimi_2021}{Logic circuit programming in VHDL of an equalization algorithm of a gray-scale image histogram} \\
