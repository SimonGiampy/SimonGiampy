...
\bg{cvorange}{white}{Programming}\\[0.5em]
    ...
    \bg{skilllabelcolour}{iconcolour}{C, C++} \quad \bg{skilllabelcolour}{iconcolour}{Java}  \\
    \bg{skilllabelcolour}{iconcolour}{Python} \quad \bg{skilllabelcolour}{iconcolour}{Matlab}  \\
    \bg{skilllabelcolour}{iconcolour}{ROS, ROS2} \quad \bg{skilllabelcolour}{iconcolour}{SQL}  \\
...
\bg{skilllabelcolour}{iconcolour}{IMU} \quad \bg{skilllabelcolour}{iconcolour}{Wheels encoders}
...
\section*{Some Projects at Polytechnic of Milan}
\begin{tabular}{r| p{0.64\textwidth} }
    ...
    \cvproj{2022}{STM32 Nucleo with Miosix Embedded OS kernel-space programming}{STM32 $\cdot$ Embedded OS programming $\cdot$ C++ $\cdot$ Linux}{https://github.com/SimonGiampy/STM32-Miosix-GameOfLife}{Development of John Conway's Game of Life cellular automaton on an STM32 running Miosix embedded OS in kernel-space and communicating via serial interface with an emulated terminal on a Linux machine.} \\
     ...
     \cvproj{2021}{SW engineering project: an online multi-player board game}{Java $\cdot$ Game $\cdot$ Large group project $\cdot$ Git}{https://github.com/SimonGiampy/Ing_Sw_Progetto_Polimi_2021}{Large group project development in Java (with terminal and GUI interfaces) of a multi-player online board game: Maestri del Rinascimento. Very large code base.} \\
