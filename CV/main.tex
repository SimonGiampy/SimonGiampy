...
\bg{cvgreen}{white}{Personal} \\[0.4em]
...
\bg{cvgreen}{white}{Areas of Expertise} \\[0.4em]

Robotics ~•~ Deep Learning \\ Artificial Intelligence \\ Computer Vision ~•~ Perception \\ Parallel Computing

\bigskip

\bg{cvgreen}{white}{Interests}\\[0.4em]

Robotics ~•~ AI ~•~ AeroSpace

\bigskip

\bg{cvgreen}{white}{Contacts}\\[0.4em]
...
\bg{cvgreen}{white}{Programming Languages}\\[0.4em]
...
\bg{cvgreen}{white}{Frameworks \& Libraries}\\[0.4em]
    \bg{skilllabelcolour}{iconcolour}{ROS2, MoveIt2, Nav2} \, \bg{skilllabelcolour}{iconcolour}{Docker} \\[0.1em]
    ...
    \bg{skilllabelcolour}{iconcolour}{Pandas, Scikit-Learn, Scipy}
\bigskip

\bg{cvgreen}{white}{Robots \& Sensors} \\[0.4em]
...
\bg{cvgreen}{white}{Embedded Systems}\\[0.4em]
